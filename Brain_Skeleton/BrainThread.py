...
class BrainThread(Thread):
    ...
    def path_tracking(self, case=None,
        ...
        if case == "roundabout_forward":
            ...
            size_pixel = 500
            size_cm = 234
            ref_points_aux = pathGenerator.generate_circle_points(r=55, d=20, x_c=99, y_c=117, alpha_min=0,
                                                                  alpha_max=1.57)
            for point in ref_points_aux:
                ref_points.append(point)
            ref_points_aux = pathGenerator.generate_circle_points(r=55, d=10, x_c=99, y_c=117, alpha_min=5.23,
                                                                  alpha_max=6.05)
            for point in ref_points_aux:
                ref_points.append(point)
            ...
            ref_points_aux = pathGenerator.generate_line_points(x1=117, y1=20, x2=117, y2=55, n=8)
            for point in ref_points_aux:
                ref_points.append(point)
            ref_points_aux = pathGenerator.generate_line_points(x1=117, y1=179, x2=117, y2=224, n=8)
            for point in ref_points_aux:
                ref_points.append(point)
