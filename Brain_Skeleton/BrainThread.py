...
class BrainThread(Thread):
    ...
    def path_tracking(self, case=None,
        ...
        if case == "roundabout_forward":
            ...
            size_pixel = 500
            size_cm = 234
            ref_points_aux = pathGenerator.generate_circle_points(r=67, d=5, x_c=99, y_c=117, alpha_min=0.4,
                                                                  alpha_max=1.12)
            ...
            ref_points.append((107, 204))
            ref_points.append((107, 194))
            ref_points.append((107, 184))
